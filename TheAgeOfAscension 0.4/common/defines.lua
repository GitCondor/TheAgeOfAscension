...
country = {
	...
	MONTHS_UNTIL_BROKEN 		= 1,    -- OBSOLETE! (Months until rebel held capital results in broken country.)
	...
	GREATNESS_DAYS = 30, 	   -- how many days until country risks losing status as great nation
	BADBOY_LIMIT = 30,
	...
	COLONIAL_RANK = 20, -- Minimum rank a nation must have to send colonists
...
diplomacy = {
	...
	REMOVEFROMSPHERE_INFLUENCE_COST = 65,
	...
	TWS_GRACE_PERIOD_DAYS = 330, -- Ticking War Score delay before it starts falling down for not fulfilling CB.
